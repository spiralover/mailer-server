...
impl AuthService {
    pub fn login(
        ...
        let context_less_error_message = Err(AppMessage::WarningMessageStr(
        ...
        if !user.is_verified.to_owned() {
            ...
            return Err(AppMessage::WarningMessageStr("Your account has not been verified, please check your mailbox or resend verification code"));
        }
        ...
        if user.has_started_password_reset.to_owned() {
            ...
            return Err(AppMessage::WarningMessageStr("You have started password reset, please follow the link sent to your email to complete it"));
        }
        ...
        if user.status == UserStatus::Inactive.to_string() {
            ...
            return Err(AppMessage::WarningMessageStr("Your account is not active"));
        }
        ...
        Ok(AppMessage::SuccessMessageStr(
